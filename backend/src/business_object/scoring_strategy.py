...
from business_object.player import Game


class ScoringStrategy:
    @classmethod
    def calculate_expected_score(cls, elo_a: int, elo_b: int) -> float:
    ...
    @classmethod
    def calculate_new_ratings(cls, elo_a: int, elo_b: int, player_a_won: bool) -> tuple[int, int]:
